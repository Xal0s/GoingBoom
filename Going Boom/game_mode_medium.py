...
def going_boom_medium():    # Couleurs qui seront utilisées dans le jeu
    WHITE = (255, 255, 255)
    ...
    # Nos questions
    questions = [
        "Quelle traversee Louis Bleriot a reussi en 1909 ?",
        "Quel est le taux d'alcool a ne pas depasser pour prendre le volant ? en g/litre de sang",
        "Qui joue Blaze aux cotes de Louis de Funes dans la folie des grandeurs?",
        "Quelle est la hauteur total de la tour Eiffel ?",
        "Qui etait surnomme 'l'incorruptible sous la Revolution ?",
        "Qui a gagne pour la seconde fois le tour de France en 2021 ?",
        "Qui animait l'emission de tele 'Avis de Recherche' ?",
        "Qui a realise le 'Fabuleux destin d'Amelie Poulain ?",
        "Qui a remplace DSK a la tete du FMI en 2011 ?",
        "Quelle profession est concernée par le serment d'hippocrate ?",
        "Que veut dire l'acronyme de la chanson Y.M.C.A en français ?",
        "Quelle est la journée des droits de la femme ?",
        "En quelle année le mur de Berlin a ete construit ?"
    ]
    # Nos réponses
    reponses = ["La manche", "0,5", "Yves Montand","330","Robespierre","Tadej Pogacar","Patrick sabatier" ,"jean-pierre jeunet","christine lagarde","les medecins","Union chretienne des jeunes hommes","8 mars","1961"]
